    ...
    <div class="formWrapper-Autofit">
        <fieldset>
            ...
            <form action="" method="post">
                Scheme ID:<input type="text" class="form-TxtInput"
                                 name="txtSchemeName" disabled
                                 value="<?php echo $SchemeName[0]['SchemeName'] ?>">
                Description of Work:<input type="text" class="form-TxtInput"
                                           name="txtWork"
                                           value="<?php echo $work[0]['WorkDescription'] ?>">
                Estimated Cost:<input type="text" class="form-TxtInput"
                                      name="txtCost"
                                      value="<?php echo $work[0]['EstimatedCost'] ?>">
                Allotment Amount:<input type="text" class="form-TxtInput"
                                        name="txtAmount"
