          ...
          ?>
            <fieldset>
                ...
                <div class="FieldGroup">
                    <label for="DeptName"><span
                                id="myfont">Name of Department</span>
                ...
                <div class="FieldGroup">
                    <label for="SectorName"><span
                                id="myfont">Name of Sector</span>
            ...
            <fieldset>
                ...
                <div class="FieldGroup">
                    <label for="SchemeName"><span
                                id="myfont">Name of Schemes</span>
              ...
              ?>
                ...
                <div class="FieldGroup">
                    <label for="ProjectName"><span
                                id="myfont">Name of Project</span>
                        <input type="text" name="ProjectName" id="ProjectName"
                               placeholder="Name of Projects"/>
                    </label>
                </div>
                <div class="FieldGroup">
                    <label for="ProjectCost"><span
                                id="myfont">Project Cost</span>
                ...
                Project Allotment Amount</span>
                        <input type="text" name="AlotmentAmount"
                               id="AlotmentAmount"
                ...
                <div class="FieldGroup">
                    <label for="StartDate"><span
                                id="myfont">Project Start Date</span>
