    ...
    <div class="formWrapper">
        <form method="post" action="Projects.php">
            ...
            <div class="FieldGroup">
                <label for="SchemeName"><strong>Name of
                        Scheme</strong></label><br/>
            ...
            <div class="FieldGroup">
                <label for="AlotmentAmount"><strong>Project Allotment
                        Amount</strong>
                </label>
            ...
            <div class="FieldGroup">
                <label for="AlotmentDate"><strong>Project Allotment
                        Date</strong>
                </label>
            ...
            <div class="FieldGroup">
                <label for="WorkOrderDate"><strong>Project Work Order
                        Date</strong>
                </label>
