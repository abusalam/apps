        ...
        <form id="frmWorks" action="" method="post">
            ...
            <div class="FieldGroup">
                <label for="txtWork"><strong>Description of Work:</strong><br/>
                    <input id="txtWork" type="text" name="txtWork"
                           class="form-TxtInput" style="width: 410px;">
                </label>
            </div>
            <br/>
            ...
            <div class="FieldGroup">
                <label for="txtCost"><strong>Estimated Cost:</strong><br/>
                    <input id="txtCost" type="text" name="txtCost"
                           class="form-TxtInput" style="width: 80px;">
                </label>
            </div>
            <div class="FieldGroup">
                <label for="txtWorkRemarks"><strong>Items/Remarks:</strong><br/>
                    <input id="txtWorkRemarks" type="text" name="txtWorkRemarks"
                           class="form-TxtInput" style="width: 275px;">
                </label>
            </div>
