          ...
          <form id="ChgPwd-frm" action="Profile.php" method="post"
              ...
              <div id="chgpwd-dlg" title="Change Password">
                  <div class="FieldGroup">
                      <label for="txtAmount"><strong>Current Password:</strong><br/>
                  ...
                  <div class="FieldGroup">
                      <label for="txtBalance"><strong>New Password: </strong><span id="PwdScore"></span><br/>
                  ...
                  <div style="clear: both;"></div>
                  <div class="FieldGroup">
                      <label for="txtBalance"><strong>Confirm New Password: </strong><span id="PwdMatch"></span><br/>
