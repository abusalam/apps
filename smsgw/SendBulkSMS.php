...
<form method="post" action="SendBulkSMS.php">
    ...
    <input id="AppMobile" type="text" name="AppMobile"
           value="<?php echo GetVal($_POST, "AppMobile"); ?>"/>
    <input id="ChkUseDBYes" type="radio" value="Yes" name="ChkUseForm"
           checked="checked"/>
    <label for="ChkUseDBYes">Yes</label>
    <input id="ChkUseDBNo" type="radio" value="No" name="ChkUseForm"
           checked="checked"/>
    <label for="ChkUseDBNo">No</label><br/>
    <textarea rows="20" cols="120"
              name="TextSMS"><?php echo GetVal($_SESSION, "TextSMS"); ?></textarea>
